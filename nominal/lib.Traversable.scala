...
object Traversable {
  ...
  type Endofunctor3 = Traversable3 {
    type Cat1 = Any ; type Cat2 = Any ; type Cat3 = Any
    type Map[+A, +B, +C]
  }

  type Endofunctor4 = Traversable4 {
    type Cat1 = Any ; type Cat2 = Any ; type Cat3 = Any ; type Cat4 = Any
    type Map[+A, +B, +C, +D]
  }
...
trait Traversable { thisFunctor =>
  ...
  def traverse[A <: Cat, B <: Cat](G: Applicative)(f: A => G.Map[B]): this.Map[A] => G.Map[this.Map[B]]
